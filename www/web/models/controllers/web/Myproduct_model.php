...
class Myproduct_model extends CI_Model
{
    ...
    {
        $sql = "SELECT id, kindpname, mainimage, prodtitle, regdate, prodstate, sellprice, brand, readcount, interestcnt, chattcnt, soldout, linkurl, size, optioninfo FROM product
