    ...
    <div class="container content no-top-space">
        ...
        <div class="row">
            ...
            <div class="col-md-8 tag-box tag-box-v3">
                <div class="headline"><h3> &nbsp; 이용약관 &nbsp; </h3></div>
                <div class="margin-bottom-25"></div>
                <h2> &nbsp;&nbsp;&nbsp;  furnipeople 서비스 이용 약관</h2>
                <!-- 이용 약관 -->
                <div class="tag-box tag-box-v6">

                    <p>
   제 1조 (목적) furnipeople서비스 이용약관(이하 “퍼니피플”이라 합니다)은 주식회사 퍼니피플(이하 “회사”라 합니다)가 제공하는 서비스와 관련하여 회사와 이용 고객(또는 회원) 간에 서비스의 이용 조건 및 절차, 회사와 회원 간의 권리, 의무 및 책임 사항 기타 필요한 사항을 규정함을 목적으로 합니다.<br>
<br>
   제 2조 (용어) 본 약관에서 사용하는 용어의 정의는 다음 각 호와 같으며, 정의되지 않은 용어에 대한 해석은 관계법령 및 서비스별 안내에서 정하는 바에 따릅니다.<br>
   1. furnipeople 서비스(이하 “서비스”라 합니다): 이용 고객 또는 회원이 PC, 휴대형 단말기, 태블릿PC 등 각종 유무선 기기 또는 프로그램을 통하여 이용할 수 있도록 회사가 제공하는 가구 / 인테리어 관련 컨텐츠 및 업체회원 찾기, 가구 / 인테리어 관련 콘텐츠 및 그 외 관련된 서비스를 말합니다.<br>
   2. 회원: 회사의 서비스에 접속하여 본 약관에 동의하고 ID와 PASSWORD를 발급 받았으며 회사가 제공하는 서비스를 이용하는 고객을 포괄적으로 의미합니다<br>
   3. 업체회원: 인테리어 관련 서비스나 제품을 판매하는 직종에 종사하는 회원 중 회사가 지정한 절차 및 검수를 마치고 해당 회원의 서비스와 제품에 대한 정보 및 상담을 제공할 수 있는 회원을 의미합니다. 본 약관에서 별도로 업체회원을 언급하지 않는 경우에는 모든 약관의 조항들이 업체회원에게도 회원과 동일하게 적용됩니다.<br>
   ...
   5. 업체회원정보: 업체회원이 되기 위해 회사가 지정한 절차 및 검수 과정에서 기재하는 업체회원의 정보를 의미합니다. 사업자 등록증과 포트폴리오가 필요합니다. <br>
...
<br>
   ...
   ③ 회사는 약관을 개정할 경우 그 개정이유 및 적용일자를 명시하여 현행 약관과 함께 적용일 전일까지 제1항의 방법으로 공지합니다. 다만, 회원의 권리 또는 의무에 관한 중요한 규정의 변경은 개정약관을 회원이 등록한 E-mail로 발송하여 통지합니다.<br>
...
<br>
   제4조 (약관 외 준칙) 본 약관에 명시되지 않은 사항에 대해서는 정보통신망 이용촉진 및 정보보호 등에 관한 법률, 약관의 규제에 관한 법률, 전기통신사업법 등 관계법령 및 회사가 정한 서비스의 세부이용지침 등의 규정에 따릅니다.<br>
<br>
   제5조 (이용계약의 성립)<br>
   ① 서비스 이용계약은 회사가 정한 가입 양식에 따라 회원정보(전자우편주소, 비밀번호, 별명 등)를 기입하여 회원가입신청을 하고 회사가 이러한 신청에 대하여 승인함으로써 체결됩니다.<br>
   ② 업체회원 가입의 경우에는 인테리어 관련 서비스나 제품을 판매하는 직종에 종사하는 회원이 회사가 정한 절차에 따라 정보를 기입하여 가입 신청을 하고 회사가 승인하면 업체회원으로서 서비스를 이용할 수 있습니다.<br>
...
<br>
   ...
   ⑤ 회사는 업체회원 가입을 신청한 회원에 대하여 회사의 업무상ㆍ기술상 또는 서비스 운영정책상 업체회원 가입을 승낙하지 않을 수 있습니다.<br>
<br>
   제7조 (회원정보의 변경)<br>
   ① 회원은 서비스를 통하여 언제든지 본인의 개인정보를 열람하고 수정할 수 있습니다.<br>
   ② 회원은 서비스를 이용하면서 회사에 제출한 회원정보가 변경되었을 경우 개인정보 설정 화면에서 회원정보를 수정하여야 합니다.<br>
   ③ 회원정보를 수정하지 않음으로 인하여 발생하는 모든 책임은 회원에게 있습니다.<br>
   ④ 업체회원이 회사에 제출한 업체회원 정보를 변경했을 경우, 회사가 실시하는 변경된 정보에 대해 검수를 통과해야만 변경된 정보가 서비스에 반영됩니다.<br>
<br>
   제8조 (서비스의 이용)<br>
...
<br>
   ...
   ③ 회사는 지나친 광고성 게시물로 판단되는 경우 해당 게시물을 사전 통지 없이 삭제할 수 있으며, 이에 대해 회사는 어떤 책임도 지지 않습니다.<br>
   ④ 회사는 furnimarket 에 올라온 개인간 거래 목적의 게시물로 인해 발생한 어떤 문제에도 책임을 지지 않으며, 거래 간 발생한 문제에 대해서의 책임은 당사자 혹은 해당 업체에 있습니다.<br>
<br>
   제12조 (게시물의 저작권 등)<br>
...
<br>
   ...
   ③ 회원은 본 조 제3항에 따른 서비스 이용정지 기타 서비스 이용과 관련된 이용제한에 대해 관리자에게 E-mail을 통해 이의신청을 할 수 있으며, 회사는 회원의 이의신청이 정당하다고 판단되는 경우 즉시 서비스 이용을 재개합니다.<br>
...
<br>
   부칙 (시행일) 본 약관은 2016년 1월 OO일부터 시행합니다.<br>
<br>
   이용약관 변경이력<br>
   2016. 03. 01 최소 시행
                    </p>
