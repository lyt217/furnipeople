...
<?php if ($shopList) {
    foreach ($shopList as $shop): ?>
        ...
        <div class="comment">
            <img src="/static/corplogo/<?php echo $shop->corplogo; ?>">
...
{   
    ...
    var markers = [];
    var shoplist = [<?php echo $shop_jsdata; ?>];
    ...
    function setGmarkers(map) {
        for (var i = 0; i < shoplist.length; i++) {
            ...
            setGinfowindow(marker, shop[0]+' ['+shop[3]+']');
            markers.push(marker);
        }         
    }
    
    function setGinfowindow(marker, viewdata) {
