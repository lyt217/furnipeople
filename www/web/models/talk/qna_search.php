            ...
            <div class="col-md-8 tag-box tag-box-v3 form-page">
				...
				<div class="row margin-bottom-20">
					<div class="col-md-3 sm-margin-bottom-10 text-center">
						<a href="/web/talk/qna/search/all/no" class="btn-u btn-u-lg rounded-3x btn-u-brown btn-talk" type="button">&nbsp;&nbsp; 전 체 &nbsp;&nbsp;</a>
					</div>
					<div class="col-md-9 no-space-left">
						<div style="line-height: 2.6;">
							<a href="/web/talk/qna/search/free/no" class="<?php echo $talkind_btn['a']; ?>" type="button">&nbsp;&nbsp; 자유 &nbsp;&nbsp;</a> &nbsp;
							<a href="/web/talk/qna/search/chair/no" class="<?php echo $talkind_btn['b']; ?>" type="button">&nbsp;&nbsp; 의자 &nbsp;&nbsp;</a> &nbsp;
							<a href="/web/talk/qna/search/desk/no" class="<?php echo $talkind_btn['c']; ?>" type="button">&nbsp;&nbsp; 책상 &nbsp;&nbsp;</a> &nbsp;
							<a href="/web/talk/qna/search/sofa/no" class="<?php echo $talkind_btn['d']; ?>" type="button">&nbsp;&nbsp; 쇼파 &nbsp;&nbsp;</a> &nbsp;
							<a href="/web/talk/qna/search/bed/no" class="<?php echo $talkind_btn['e']; ?>" type="button">&nbsp;&nbsp; 침대 &nbsp;&nbsp;</a> &nbsp;
							<a href="/web/talk/qna/search/dresser/no" class="<?php echo $talkind_btn['f']; ?>" type="button">&nbsp;&nbsp; 화장대 &nbsp;&nbsp;</a> &nbsp;
							<a href="/web/talk/qna/search/dtable/no" class="<?php echo $talkind_btn['g']; ?>" type="button">&nbsp;&nbsp; 식탁 &nbsp;&nbsp;</a> &nbsp;
							<a href="/web/talk/qna/search/closet/no" class="<?php echo $talkind_btn['h']; ?>" type="button">&nbsp;&nbsp; 수납장 &nbsp;&nbsp;</a> &nbsp;
							<a href="/web/talk/qna/search/drawer/no" class="<?php echo $talkind_btn['i']; ?>" type="button">&nbsp;&nbsp; 서랍 &nbsp;&nbsp;</a> &nbsp;
							<a href="/web/talk/qna/search/interior/no" class="<?php echo $talkind_btn['j']; ?>" type="button">&nbsp;&nbsp; 인테리어 제품 &nbsp;&nbsp;</a> &nbsp;
							<a href="/web/talk/qna/search/etc/no" class="<?php echo $talkind_btn['k']; ?>" type="button">&nbsp;&nbsp; 기타 가구들 &nbsp;&nbsp;</a>
							<!--button class="btn-u btn-brd-hover rounded-3x btn-u-default btn-u-sm text-bold" type="button">&nbsp;&nbsp; 샘플 &nbsp;&nbsp;</button-->
						</div>
					</div>
				</div>
					...
					<form class="form-inline" role="form" action="" method="post" accept-charset="utf-8">
						<div class="input-group">
							...
							<select name="search_field" class="form-control">
                                ...
                                <option value="questionsrh" <?php echo set_select('search_field', 'questionsrh', @$search_field[2]); ?>>내용</option>
							</select>
						</div>
						<div class="input-group">
							...
							<!--span class="input-group-btn"><button class="btn-u btn-u-default" type="button" onclick="javascript:window.location.href='/web/talk/qna/search/all/no'"> 초기화</button></span-->
						</div>
					</form>
				</div>
                <!-- End Inline Search -->
                ...
                <table class="table table-hover hrefcolor-basic">
                    <thead>
                        <tr>
                            <th class="hidden-sm" style="font-size: 12px;">번호</th>
                            <th class="hidden-sm" style="font-size: 12px;">분류</th>
                            <th style="font-size: 12px;">제목</th>
                            <th style="font-size: 12px;">글쓴이</th>
                            <th class="hidden-sm" style="font-size: 12px;">날짜</th>
                            <th class="hidden-sm" style="font-size: 12px;">조회수</th>
                            <th class="hidden-sm" style="font-size: 12px;">추천수</th>
                        </tr>
                    </thead>
                    <tbody>
                    	<?php if ($articleList) {
                        ...
                        <tr>
                            <td class="hidden-sm" style="font-size: 12px;"><?php echo $numbering--; ?></td>
                            <td class="hidden-sm" style="font-size: 12px;"><?php echo $article->kindpname; ?></td>
                            <td style="font-size: 12px;">
                                <a href="/web/talk/qna/article/<?php echo $article->id; ?>"><?php echo title_utfcut($article->title); ?></a> <?php echo ($article->mentcount > 0) ? '&nbsp;&nbsp;<i class="fa fa-comments"></i> (' . $article->mentcount . ')' : ''; ?>
                            	<?php echo ($article->answertitle) ? '&nbsp;<span class="text-highlights text-highlights-purple">답변</span>' : ''; ?>
              							</td>
                            <td class="hidden-sm" style="font-size: 12px;"><?php
                            ...
                            <td class="hidden-sm" style="font-size: 12px;"><?php echo date('Y.m.d', strtotime($article->regdate)); ?></td>
                            <td class="hidden-sm" style="font-size: 12px;"><?php echo $article->readcount; ?></td>
                            <td class="hidden-sm" style="font-size: 12px;"><?php echo $article->onechucnt; ?></td>
                        </tr>
						<?php endforeach; } ?>
                    </tbody>
                </table>
				...
				<div class="text-right">
					<a class="btn-u btn-u-dark-blue" href="/web/talk/qna/create"> &nbsp;&nbsp; 글작성 &nbsp;&nbsp; </a>
				</div>
