...
$payLocalUrl = "http://www.furnipeople.com";   //상점 도메인
?>
...
<link rel="stylesheet" href="/assets/css/sample.css" type="text/css" media="screen" />
...
<form id="transMgr" name="transMgr" method="post" action="<?=$payActionUrl ?>/webTxInit" class="nyroModal" target="_blank">
		...
		<thead>
			<tr><td colspan="2"><img src="https://webtx.tpay.co.kr/images/bul_arrow02.gif"/>&nbsp;<strong>Furnipeople 결제</strong></td></tr>
		</thead>
		<tbody>
			<tr>
				<td>결제수단</td>
			...
			<tr>
				...
				<td><input type="text" name="goodsName" value="<?php echo $kind; ?>"></td>
			</tr>
			<tr>
				<td>상품가격<font color="red">(*)</font></td>
				<td><input type="text" name="amt" value="<?=$amt?>" > 원<input type="button" value="금액변경" onclick="changeAmt();"  class="button blue small"/>
						<br/> <font size="1pt" style="font-weight: bold;"> * 상품가격 변경시 금액 변경 버튼을 눌러주시기 바랍니다.</font>
				</td>
			</tr>
	...
	<table width="500px" border="0px" style="line-height:25px;">
		...
		<tr>
			<td style="vertical-align:top;">*</td>
			<td style="vertical-align:top;">테스트 아이디로 결제된 건에 대해서는 당일 오후 11:30분에 일괄 취소됩니다.<br>실제 회원사아이디 적용 시 테스트아이디가 적용되지 않도록 각별한 주의를 부탁드립니다. </td>
		</tr>
	</table>
	...
	<input type="hidden" name="buyerAddr" value="서울특별시 강남구 대치동 903-21 1층">
