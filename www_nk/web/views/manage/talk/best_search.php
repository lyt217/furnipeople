            ...
            <ul id="mainSideMenu" class="nav nav-list nav-side">
                ...
                <li class="accordion-group">
                    ...
                    <ul class="accordion-content nav nav-list collapse in" id="talkMenu">
                        ...
                        <li class="active"><a href="javascript:void(0);"><i class="fontello-icon-right-dir"></i>Furni Talk Best</a></li>                        
                    </ul>
                </li>                 
                <li class="accordion-group">
            ...
            <div class="span12 grider">
                ...
                <div class="widget widget-simple">
                    <div class="widget-header">
                        <h4><i class="fontello-icon-user opaci75"></i> Furni Talk Best <small>(총<?php echo $total_rows; ?>개)</small></h4>                                                
                    </div>
                            ...
                            <div class="table-wrapper">
                                <table class="table boo-table table-condensed table-content table-striped table-hover">
                                    ...
                                    foreach ($talkList as $talk): ?>                                
                                        <tr>
                                            <td><?php echo $talk->writer; ?></td>
                                            <td><?php echo $talk->title; ?></td>
                                            <td><?php echo date('y.m.d ag:i', strtotime($talk->regdate)); ?></td>
                                            <td>
                                                <a onclick="javascript:window.open('/web/talk/<?php echo substr($talk->taklboard_name, 4); ?>/article/<?php echo $talk->talkboard_id; ?>/rtnlist');" class="btn btn-mini btn-yellow">원문보기</a>
                                                &nbsp;
                                                <a onclick="javascript:adminDelete(<?php echo $talk->id; ?>);" class="btn btn-mini btn-orange">베스트제거</a>
                                            </td>
                                        </tr>                                        
                                    <?php endforeach; } ?>
                                    </tbody>
                                ...
                                <div class="widget-footer">                     
                                    <div class="pagination pagination-btn text-center margin-top10">                                        
                                        ...
                                        <ul class="hidden-phone">
                                            <li><a href="/web/manage/ttalk/besttalk" class="btn margin-left10">리셋</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
