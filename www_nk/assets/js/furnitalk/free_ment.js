(function($){
    ...
    $.fn.rootment = function (options) {
        ...
        function memberMentSubmit() {            
            $.ajax({ 
                type: 'POST', 
                url: '/web/talk/comment/create/talkfree',
                dataType: 'json',
                data: { 
        ...
        function guestMentSubmit() {            
            $.ajax({ 
                type: 'POST', 
                url: '/web/talk/comment/gecreate/talkfree',
                dataType: 'json',
                data: { 
                        talk_idx: option.talkidx,
    ...
    $.fn.mentproc = function (options) {
        ...
        function memberMentSubmit() {            
            $.ajax({ 
                type: 'POST', 
                url: '/web/talk/comment/mentproc/talkfree',
                dataType: 'json',
                data: { 
                        talk_idx: option.talkidx,
        ...
        function guestMentSubmit() {            
            $.ajax({ 
                type: 'POST', 
                url: '/web/talk/comment/gementproc/talkfree',
                dataType: 'json',
                data: { 
                        talk_idx: option.talkidx,
                        ment_idx: option.mentidx,
