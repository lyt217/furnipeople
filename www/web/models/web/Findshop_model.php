...
class Findshop_model extends CI_Model
{
    ...
    public function get_more_shop_find($biz_kind){
      if ($biz_kind != 'all')
      ...
      $sql = "SELECT id, corpname, addressjibun, latitude, longitude, bizcategory, corpphone, introduce, corplogo, hashtag
          FROM provider WHERE {$bizcategory} state = 'O' ORDER BY corpname ASC";
    ...
    public function get_shop_list($start_page, $limit_page, $biz_kind)
    {
        ...
        $sql = "SELECT id, corpname, addressjibun, latitude, longitude, bizcategory, corpphone, introduce, corplogo, hashtag
            FROM provider WHERE {$bizcategory} state = 'O' ORDER BY corpname ASC LIMIT {$start_page}, {$limit_page}";
