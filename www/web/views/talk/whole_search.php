                ...
                <table class="table table-hover hrefcolor-basic" style="font-size: 12px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            	<a href="/web/talk/<?php if($article->board == 'f'){ ?>free<?php } else if($article->board == 'i'){ ?>info<?php } else if($article->board == 'p'){ ?>photo<?php } else if($article->board == 'a'){ ?>advertise<?php }?>/article/<?php echo $article->id; ?>"><?php echo title_utfcut($article->title); ?></a>
                              <?php
                                $today = new DateTime();
                                $today->setTime(0,0,0);
// 2017-08-25 23:40:14
