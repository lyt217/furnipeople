...
?>
    ...
    <!--=== Job이미지와 통검색 ===-->
    <div class="job-img margin-bottom-30" style="min-height:100px;">
    ...
    <div id="container" class="container content no-top-space" style="position:relative;">
        ...
        <div class="row" style="margin-top:-87px;">
            ...
            <div class="col-md-8 tag-box tag-box-v3 form-page">
                <div class="headline"><h3> &nbsp; Furni Talk &nbsp; </h3> &nbsp; 가구에 대해서 자유롭게 이야기하는 공간입니다.</div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td  style="font-size: 12px;">
                            	<a href="/web/talk/free/article/<?php echo $article->id; ?>">
                                <?php
                                  $today = new DateTime();
                                  $today->setTime(0,0,0);
// 2017-08-25 23:40:14
                                  ...
                                  if($diffDays > -3){
                                    echo '<img src="/assets/img/icons/icon_new.png" width="20" height="20">';
                                  }?>

                                  <?php echo title_utfcut($article->title); ?></a> <?php echo ($article->mentcount > 0) ? '&nbsp;&nbsp;<i class="fa fa-comments"></i> (' . $article->mentcount . ')' : ''; ?>
                            	<!--span class="badge badge-aqua rounded">New</span-->
							</td>
                            <td class="hidden-sm"  style="font-size: 12px;">
                              <?php
...
// 2017-08-25 23:40:14
                                  ...
                                  if($diffDays == 0){
                                    echo date('H:i', strtotime($article->regdate));
                                  }
                                  else{
                                    echo date('Y.m.d', strtotime($article->regdate));
                                  } ?></td>
				...
				<div class="text-right">
					<a class="btn-u btn-u-dark-blue" href="/web/talk/free/create"> &nbsp;&nbsp; 글작성 &nbsp;&nbsp; </a>
				</div>
