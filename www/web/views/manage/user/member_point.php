            ...
            <div class="span12 grider">
                ...
                <div class="widget widget-simple">
                    <div class="widget-header">
                        <h4><i class="fontello-icon-user opaci75"></i> 회원 월별 포인트 관리 <!--small>설명필용시</small--></h4>
                        <form class="form-inline text-center hidden-phone" action="<?php echo $action_url; ?>" method="post" id="month">
                        <?php if ($this->session->has_userdata('admin_find')) {
                            ...
                            <select name="srh_field" class="selecttwo" style="width:160px;" id="month_select" onchange="month_change()">
                              <?php
                                $today = date("Ymd");
                                $i = 1;
                                while($today >= '20160228'){ ?>
                                <option value="<?php echo date('Ym', strtotime($today)); ?>"><?php echo date('Y년 m월', strtotime($today)); ?> </option>
                                <?php $today = date("Ymd",strtotime ("-$i months"));
                                $i++;
                              } ?>
                            </select>
                        </form>
                            ...
                            <div class="table-wrapper">
                                <table class="table boo-table table-condensed table-content table-striped table-hover">
                                    ...
                                    foreach ($userList as $user): ?>
                                        <tr>
                                            <td><?php echo $user->name; ?><br><?php echo $user->phone; ?></td>
                                            <td><?php echo $user->emailid; ?><br><?php echo $user->nickname; ?></td>
                                            <td><?php echo $user->usrpoint; ?> 포인트<br> </td>
