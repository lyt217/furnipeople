...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({
	...
	makePopupURL : function(){
		var sPopupUrl = "/assets/plugins/se2/photo_uploader/popup/photo_uploader.html";
	...
	_getPhotoTag : function(htPhotoInfo){
		...
		var sTag = '';
		console.log(htPhotoInfo.nWidth);
		// if(htPhotoInfo.nWidth > 740){
		sTag += '<img src="{=sOriginalImageURL}" title="{=sName}" style="width:720px;">';
