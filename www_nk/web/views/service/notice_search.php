        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <ul class="list-unstyled blog-photos">
                    ...
                    <!--li><a href="#"><img src="/static/webimage/btn-mymini2.png" alt="마이에그" class="hover-effect"></a></li>
                    <li><a href="#"><img src="/static/webimage/btn-mymini3.png" alt="마이포인트" class="hover-effect"></a></li-->
                    <li><a href="#"><img src="/static/webimage/btn-mymini4.png" alt="관심가구" class="hover-effect"></a></li>
                    <li><a href="#"><img src="/static/webimage/btn-mymini5.png" alt="내등록물건" class="hover-effect"></a></li>
                    <li><a href="#"><img src="/static/webimage/btn-mymini6.png" alt="내가쓴글" class="hover-effect"></a></li>
                </ul>
