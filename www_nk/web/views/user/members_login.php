    ...
    <div class="container content no-top-space">
        ...
        <div class="row">
            ...
            <div class="col-md-8 tag-box tag-box-v3 form-page">
                <div class="headline"><h3> &nbsp; 회원 로그인 &nbsp; </h3></div>
                ...
                <div class="row">
					...
					<div class="col-md-6">
						<div class="form-group margin-top-20 margin-bottom-25" style="text-align: center;">							
							<h1><small><strong>회원가입</strong>이 완료되었습니다.</small></h1>
						</div>
						<div class="form-group" style="text-align: center;">							
							<p>회원님의 가입 E-mail은 <?php echo $user_email; ?> 입니다.</p>
						</div>
					</div>							                			                	
		            <div class="col-md-3"></div>                    	
				</div>
                ...
                <!-- Login -->
                <div class="row">
				<form class="form-horizontal" role="form" action="/web/user/membership/index" method="post" accept-charset="utf-8">					
					...
					<div class="col-md-4">
						...
						<div class="form-group no-margin-bottom">
							...
							<input type="password" name="pass_word" class="form-control" maxlength="12">			                        
							<?php echo form_error('pass_word', '<div class="alert alert-warning fade in">', '</div>'); ?>
						</div>
						...
						<div class="form-group">
							<button class="btn-u btn-block btn-u-dark-blue" type="submit">로그인</button>
						</div>
