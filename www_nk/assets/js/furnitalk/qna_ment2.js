(function($){
    /**
     * 주의) 이것은 free_ment.js 등과는 조금 다르니 카피해 쓰지 말 것. QnA 전용임
     * 신규 루뜨 댓글 작성
    ...
    $.fn.rootment = function (options) {
        ...
        function memberMentSubmit() {            
            $.ajax({ 
                type: 'POST', 
                url: '/web/talk/comment/create/talkqna',
                dataType: 'json',
                data: { 
        ...
        function guestMentSubmit() {            
            $.ajax({ 
                type: 'POST', 
                url: '/web/talk/comment/gecreate/talkqna',
                dataType: 'json',
                data: { 
                        talk_idx: option.talkidx,
    ...
    $.fn.mentproc = function (options) {
        ...
        function memberMentSubmit() {            
            $.ajax({ 
                type: 'POST', 
                url: '/web/talk/comment/mentproc/talkqna',
                dataType: 'json',
                data: { 
                        talk_idx: option.talkidx,
        ...
        function guestMentSubmit() {            
            $.ajax({ 
                type: 'POST', 
                url: '/web/talk/comment/gementproc/talkqna',
                dataType: 'json',
                data: { 
                        talk_idx: option.talkidx,
                        ment_idx: option.mentidx,
