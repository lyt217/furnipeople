            ...
            <ul id="mainSideMenu" class="nav nav-list nav-side">
                ...
                <li class="accordion-group">
                    ...
                    <ul class="accordion-content nav nav-list collapse in" id="talkMenu">
                        ...
                        <li class="active"><a href="javascript:void(0);"><i class="fontello-icon-right-dir"></i>Furni Q&amp;A</a></li>
            ...
            <div class="span12 grider">
                ...
                <div class="widget widget-simple">
                    <div class="widget-header">
                        <h4><i class="fontello-icon-user opaci75"></i> Furni Q&amp;A <small>(총<?php echo $total_rows; ?>개)</small></h4>
                        ...
                        <?php if ($this->session->has_userdata('admin_find')) {
                            ...
                            <a href="/web/manage/ttalk/talkqna/id-desc/<?php echo $srh_mode; ?>" class="btn btn-small btn-navi">작성순</a>
                            <a href="/web/manage/ttalk/talkqna/mentcount-desc/<?php echo $srh_mode; ?>" class="btn btn-small btn-navi">댓글순</a>
                            <a href="/web/manage/ttalk/talkqna/readcount-desc/<?php echo $srh_mode; ?>" class="btn btn-small btn-navi">열람순</a>
                            <a href="/web/manage/ttalk/talkqna/onechucnt-desc/<?php echo $srh_mode; ?>" class="btn btn-small btn-navi">추천순</a><span class="padding-side5"></span>
                            ...
                            <span class="input-append"><button class="btn" type="submit">검색</button><button class="btn" type="button" onclick="window.location.href='/web/manage/ttalk/talkqna';">리셋</button></span>
                        </form>
                    </div>
                                    ...
                                    foreach ($talkList as $talk): ?>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <?php echo ($talk->answer) ? '[답변] ' . $talk->answer : ''; ?>
                                            </td>
                                            <td colspan="4">
                                                <a onclick="javascript:window.open('/web/talk/qna/article/<?php echo $talk->id; ?>/rtnlist');" class="btn btn-mini btn-yellow">글보기</a>
                                                ...
                                                <?php } ?>&nbsp;
                                                <a onclick="javascript:window.open('/web/talk/qna/answer/<?php echo $talk->id; ?>');" class="btn btn-mini btn-orange">답변작성/수정</a>
                                                <a onclick="javascript:tobestCopy(<?php echo $talk->id; ?>, 'talkqna');" class="btn btn-mini btn-orange">베스트등록</a>
                                                <a onclick="javascript:adminDelete(<?php echo $talk->id; ?>);" class="btn btn-mini btn-orange">글삭제</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; } ?>
                                    </tbody>
                                ...
                                <div class="widget-footer">
                                    <div class="pagination pagination-btn text-center margin-top10">
                                        ...
                                        <ul class="hidden-phone">
                                            <li><a href="/web/manage/ttalk/talkqna" class="btn margin-left10">리셋</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
