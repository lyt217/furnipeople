    ...
    <div class="container content no-top-space">
        ...
        <div class="row">
            ...
            <div class="col-md-8 tag-box tag-box-v3 form-page">
				...
				<form class="form-horizontal" id="talk-form" role="form" action="/web/talk/photo/<?php echo $submit_action; ?>" method="post" accept-charset="utf-8">
					<div class="row">
						<div class="col-md-3">
...
$(document).ready(function ()
{
  ...
  //    */
	...
	// 			}
	// 		};
	// 		xhr.open("POST", "/web/talk/photo/ajax_upload_photo");
  ...
  //       document.getElementById("xhr_upload").onclick = function (e) {
    ...
    $('#delete-btn').bind('click', function () {
        $('#talk-form').attr('action', '/web/talk/photo/<?php echo $submit_action; ?>/delete').submit();
    });
    <?php } ?>
