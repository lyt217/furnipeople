                ...
                <table class="table table-hover hrefcolor-basic">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            	<a href="/web/talk/free/article/<?php echo $article->id; ?>"><?php echo title_utfcut($article->title); ?></a> <?php echo ($article->mentcount > 0) ? '&nbsp;&nbsp;<i class="fa fa-comments"></i> (' . $article->mentcount . ')' : ''; ?>
