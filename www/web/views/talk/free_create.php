       ...
       ?>
           <div class="row">
            <div class="col-md-8 tag-box tag-box-v3 form-page">
				...
				<form class="form-horizontal" id="talk-form" role="form" action="/web/talk/free/<?php echo $submit_action; ?>" method="post" accept-charset="utf-8">
					<div class="row">
						<div class="col-md-3">
                  ...
                  <textarea style="width:100%; height:500px;" name="talk_content" id="talk_content" rows="10" cols="100"><?php echo set_value('talk_content', @$articleOne->content); ?></textarea>
                	...
                	<!-- <textarea name="talk_content" class="summernote" id="summernote">/textarea> -->
...
$(document).ready(function ()
{
  ...
  //    */
	...
	// 			}
	// 		};
	// 		xhr.open("POST", "/web/talk/free/ajax_upload_photo");
  ...
  //       document.getElementById("xhr_upload").onclick = function (e) {
    ...
    $('#delete-btn').bind('click', function () {
        ...
        $('#talk-form').attr('action', '/web/talk/free/<?php echo $submit_action; ?>/delete').submit();
    });
    <?php } ?>
