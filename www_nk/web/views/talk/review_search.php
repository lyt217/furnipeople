            ...
            <div class="col-md-8 tag-box tag-box-v3 form-page">
				...
				<div class="row margin-bottom-20">
					<div class="col-md-3 sm-margin-bottom-10 text-center">
						<a href="/web/talk/review/search/all/no" class="btn-u btn-u-lg rounded-3x btn-u-brown btn-talk" type="button">&nbsp;&nbsp; 전 체 &nbsp;&nbsp;</a>
					</div>
					<div class="col-md-9 no-space-left">
						<div style="line-height: 2.6;">
							<a href="/web/talk/review/search/free/no" class="<?php echo $talkind_btn['a']; ?>" type="button">&nbsp;&nbsp; 자유 &nbsp;&nbsp;</a> &nbsp;
							<a href="/web/talk/review/search/chair/no" class="<?php echo $talkind_btn['b']; ?>" type="button">&nbsp;&nbsp; 의자 &nbsp;&nbsp;</a> &nbsp;
							<a href="/web/talk/review/search/desk/no" class="<?php echo $talkind_btn['c']; ?>" type="button">&nbsp;&nbsp; 책상 &nbsp;&nbsp;</a> &nbsp;
							<a href="/web/talk/review/search/sofa/no" class="<?php echo $talkind_btn['d']; ?>" type="button">&nbsp;&nbsp; 쇼파 &nbsp;&nbsp;</a> &nbsp;
							<a href="/web/talk/review/search/bed/no" class="<?php echo $talkind_btn['e']; ?>" type="button">&nbsp;&nbsp; 침대 &nbsp;&nbsp;</a> &nbsp;
							<a href="/web/talk/review/search/dresser/no" class="<?php echo $talkind_btn['f']; ?>" type="button">&nbsp;&nbsp; 화장대 &nbsp;&nbsp;</a> &nbsp;
							<a href="/web/talk/review/search/dtable/no" class="<?php echo $talkind_btn['g']; ?>" type="button">&nbsp;&nbsp; 식탁 &nbsp;&nbsp;</a> &nbsp;
							<a href="/web/talk/review/search/closet/no" class="<?php echo $talkind_btn['h']; ?>" type="button">&nbsp;&nbsp; 수납장 &nbsp;&nbsp;</a> &nbsp;
							<a href="/web/talk/review/search/drawer/no" class="<?php echo $talkind_btn['i']; ?>" type="button">&nbsp;&nbsp; 서랍 &nbsp;&nbsp;</a> &nbsp;
							<a href="/web/talk/review/search/interior/no" class="<?php echo $talkind_btn['j']; ?>" type="button">&nbsp;&nbsp; 인테리어 제품 &nbsp;&nbsp;</a> &nbsp;
							<a href="/web/talk/review/search/etc/no" class="<?php echo $talkind_btn['k']; ?>" type="button">&nbsp;&nbsp; 기타 가구들 &nbsp;&nbsp;</a>
						</div>
					</div>
				</div>
				...
				<div class="margin-bottom-25 text-right">
					<form class="form-inline" role="form" action="" method="post" accept-charset="utf-8">
						...
						<div class="input-group">
							...
							<!--span class="input-group-btn"><button class="btn-u btn-u-default" type="button" onclick="javascript:window.location.href='/web/talk/review/search/all/no'"> 초기화</button></span-->
						</div>
					</form>
				</div>
                <!-- End Inline Search -->
                ...
                <table class="table table-hover hrefcolor-basic">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            	<a href="/web/talk/review/article/<?php echo $article->id; ?>"><?php echo title_utfcut($article->title); ?></a> <?php echo ($article->mentcount > 0) ? '&nbsp;&nbsp;<i class="fa fa-comments"></i> (' . $article->mentcount . ')' : ''; ?>
				...
				<div class="text-right">
					<a class="btn-u btn-u-dark-blue" href="/web/talk/review/create"> &nbsp;&nbsp; 글작성 &nbsp;&nbsp; </a>
				</div>
