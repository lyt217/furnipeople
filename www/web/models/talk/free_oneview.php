        ...
        <div class="row">
            ...
            <div class="col-md-8 tag-box tag-box-v3 form-page">
                ...
                <div class="row margin-top-20">
					<div class="col-md-6">
						<a class="btn-u btn-u-default" href="/web/talk/free/update/<?php echo $articleOne->id; ?>">수정/삭제</a>
					</div>
                ...
                <div style="margin-top: 6px;">
                    <!--a class="btn-u btn-u-yellow" href="/web/talk/best/tobest/talkfree/<?php echo $articleOne->id; ?>">베스트글로 등록</a-->
                    <a onclick="javascript:window.open('/web/manage/ttalk/article/<?php echo $articleOne->id; ?>/talkfree');" class="btn-u btn-u-yellow"> &nbsp; 관리자 &nbsp; </a>
                </div>
                <?php } ?>
...
<script type="text/javascript" src="/assets/js/furnitalk/free_ment.js"></script>
...
$(document).ready(function ()
{
	...
	var calluri = '/web/talk/comment/search/talkfree/asc';
    var param_post = {
        ...
        switch (caseproc[0])
        {
            ...
            case 'replymit':
				...
				if (current_uri == '' || current_uri =='#')
					current_uri = '/web/talk/comment/search/talkfree/asc';
    ...
    $('#rootment-submit').bind('click', function (e) {
        ...
        var current_uri = '/web/talk/comment/search/talkfree/asc/'+last_page;
