       ...
       ?>
           <div class="row">
            ...
            <div class="col-md-8 tag-box tag-box-v3 form-page">
                ...
                <?php if($articleOne->rate){ ?>
                  <div class="talk-contents">
                    <span>별점 : <?php if($articleOne->rate == 5){ ?><img src="/assets/img/icons/star_on.png" style="margin-bottom:3px;"><?php } if($articleOne->rate >= 4) { ?><img src="/assets/img/icons/star_on.png" style="margin-bottom:3px;"><?php } if($articleOne->rate >= 3){ ?><img src="/assets/img/icons/star_on.png" style="margin-bottom:3px;"><?php } if($articleOne->rate >= 2){ ?><img src="/assets/img/icons/star_on.png" style="margin-bottom:3px;"><?php } if($articleOne->rate >= 1){ ?><img src="/assets/img/icons/star_on.png" style="margin-bottom:3px;"><?php } ?>(<?php echo $articleOne->rate; ?>점)</span>
                ...
                <div class="row margin-top-20">
                    <div class="col-md-6">
                        <a class="btn-u btn-u-default" href="/web/talk/review/update/<?php echo $articleOne->id; ?>">수정/삭제</a>
                    </div>
                ...
                <div style="margin-top: 6px;">
                    <!--a class="btn-u btn-u-yellow" href="/web/talk/best/tobest/talkreview/<?php echo $articleOne->id; ?>">베스트글로 등록</a-->
                    <a onclick="javascript:window.open('/web/manage/ttalk/article/<?php echo $articleOne->id; ?>/talkreview');" class="btn-u btn-u-yellow"> &nbsp; 관리자 &nbsp; </a>
                </div>
                <?php } ?>
...
<script type="text/javascript" src="/assets/js/furnitalk/review_ment.js"></script>
...
$(document).ready(function ()
{
	...
	var calluri = '/web/talk/comment/search/talkreview/asc';
    var param_post = {
        ...
        switch (caseproc[0])
        {
            ...
            case 'replymit':
				...
				if (current_uri == '' || current_uri =='#')
					current_uri = '/web/talk/comment/search/talkreview/asc';
    ...
    $('#rootment-submit').bind('click', function (e) {
        ...
        var current_uri = '/web/talk/comment/search/talkreview/asc/'+last_page;
...
function recommChu(idx) {
        $.ajax({
            url: '/web/talk/review/recomm/' + idx,
            type: 'update',
            dataType: 'json',
