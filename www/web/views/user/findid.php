    ...
    <div class="container content no-top-space">
        ...
        <div class="row">
            ...
            <div class="col-md-8 tag-box tag-box-v3 form-page">
                <div class="headline"><h3> &nbsp; 이메일 찾기 &nbsp; </h3></div>
                ...
                <!-- Login -->
                <div class="row">
				<form class="form-horizontal" role="form" action="/web/user/membership/findid" method="post" accept-charset="utf-8">
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							...
							<input type="text" name="phone" class="form-control" value="" maxlength="14" placeholder="999-9999-9999 형식">
						...
						<div class="form-group">
							<button class="btn-u btn-block btn-u-dark-blue" type="submit">이메일 찾기</button>
						</div>
