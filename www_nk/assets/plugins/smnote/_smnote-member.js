  ...
  var ImageDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div class="form-group note-group-select-from-files">' +
                ...
                '<input class="form-control filestyle" type="file" name="ajax_upload" id="xhr_field" accept="image/*" />' +                  
                '</div>' +
                '<div class="modal-footer"><button href="#" id="xhr_upload" class="btn btn-primary">사진 파일 업로드 후 본문에 추가</button></div>' +
