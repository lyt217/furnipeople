(function($){
    ...
    $.fn.rootment = function (options) {
        ...
        function memberMentSubmit() {            
            $.ajax({ 
                type: 'POST', 
                url: '/web/talk/comment/create/talkinfo',
                dataType: 'json',
                data: { 
        ...
        function guestMentSubmit() {            
            $.ajax({ 
                type: 'POST', 
                url: '/web/talk/comment/gecreate/talkinfo',
                dataType: 'json',
                data: { 
                        talk_idx: option.talkidx,
    ...
    $.fn.mentproc = function (options) {
        ...
        function memberMentSubmit() {            
            $.ajax({ 
                type: 'POST', 
                url: '/web/talk/comment/mentproc/talkinfo',
                dataType: 'json',
                data: { 
                        talk_idx: option.talkidx,
        ...
        function guestMentSubmit() {            
            $.ajax({ 
                type: 'POST', 
                url: '/web/talk/comment/gementproc/talkinfo',
                dataType: 'json',
                data: { 
                        talk_idx: option.talkidx,
                        ment_idx: option.mentidx,
