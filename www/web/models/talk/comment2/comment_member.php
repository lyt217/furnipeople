                            ...
                            <div class="media media-v2">                                
                                ...
                                <div class="media-body">
                                    ...
                                    <ul class="list-inline pull-right">
                                        ...
                                        <?php if ($ment->user_id == $this->session->userdata('user_id') &&  $ment->userdbtable == $this->session->userdata('group_table')) { ?>
                                ...
                                <div style="display: none;">
					                ...
					                <div class="row sm-margin-bottom-10">
										<div class="text-right margin-right-20 margin-bottom-5">
