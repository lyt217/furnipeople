            ...
            <ul id="mainSideMenu" class="nav nav-list nav-side">
                ...
                <li class="accordion-group">
                    ...
                    <ul class="accordion-content nav nav-list collapse in" id="memberMenu">
                        <li class="active"><a href="javascript:void(0);"><i class="fontello-icon-right-dir"></i>개인 회원</a></li>
                        <li><a href="/web/manage/pprovider/search"><i class="fontello-icon-right-dir"></i>기업 회원</a></li>
            ...
            <div class="span12 grider">
                ...
                <div class="widget widget-simple">
                    <div class="widget-header">
                        <h4><i class="fontello-icon-user opaci75"></i> 개인 회원 <!--small>설명필용시</small--></h4>
                        ...
                        <?php if ($this->session->has_userdata('admin_find')) {
                            ...
                            <a href="/web/manage/mmember/search/id-desc/<?php echo $srh_mode; ?>" class="btn btn-small btn-navi">가입순</a>
                            <a href="/web/manage/mmember/search/talkcount-desc/<?php echo $srh_mode; ?>" class="btn btn-small btn-navi">토크등록순</a>
                            <a href="/web/manage/mmember/search/goodscount-desc/<?php echo $srh_mode; ?>" class="btn btn-small btn-navi">상품등록순</a>
                            <a href="/web/manage/mmember/search/usrpoint-desc/<?php echo $srh_mode; ?>" class="btn btn-small btn-navi">포인트순</a>
                            <a href="/web/manage/mmember/search/eggticket-desc/<?php echo $srh_mode; ?>" class="btn btn-small btn-navi">에그순</a><span class="padding-side5"></span>
                            <select name="srh_field" class="selecttwo">
                                <option value="usrname" <?php echo set_select('srh_field', 'usrname', @$srh_field['usrname']); ?>>이름</option>
                            ...
                            <span class="input-append"><button class="btn" type="submit">검색</button><button class="btn" type="button" onclick="window.location.href='/web/manage/mmember/search';">리셋</button></span>
                        </form>
                    </div>
                            ...
                            <div class="table-wrapper">
                                <table class="table boo-table table-condensed table-content table-striped table-hover">
                                    ...
                                    foreach ($userList as $user): ?>
                                        <tr>
                                            <td><?php echo $user->usrname; ?><br><?php echo $user->phone; ?></td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <?php if ($user->goodscount > 0) { ?><a onclick="javascript:window.open('/web/user/shop/goods/<?php echo $user->id; ?>');" class="btn btn-mini btn-yellow">등록상품</a><?php } ?>
                                ...
                                <div class="widget-footer">
                                    <div class="pagination pagination-btn text-center margin-top10">
                                        ...
                                        <ul class="hidden-phone">
                                            <li><a href="/web/manage/mmember/search" class="btn margin-left10">리셋</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
function talkDelete(member_idx) {
    if (confirm('정말 탈퇴시키시겠습니까?')) {
        $.ajax({
            url: '/web/manage/mmember/memberdelete/' + member_idx,
            type: 'delete',
            dataType: 'text',
